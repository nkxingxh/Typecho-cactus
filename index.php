    ...
    <!-- <div class="content index width mx-auto px3 my4"> -->
        ...
        <section id="wrapper" class="home">
            <section id="about">
                ...
                </ul>. <a id="search" class="search icon" href="javascript:;"><i class="fa fa-search"></i></a>
                <p></p>
                ...
                <ul class="post-list" id="post-list">
                    <?php while ($this->next()) : ?>
                        <li class="post-item">
                            ...
                            <span>
                                <a href="<?php $this->permalink() ?>"><?php $this->sticky(38, '...');
                                                                        $this->title(38, '...') ?></a>
                            </span>
                        </li>
                    <?php endwhile; ?>
...
[xyunuser @ NKXingXh's Blog ~]$ `;
        var user1 = login + "sudo -i";
        var user2 = user1 + "\n[root @ NKXingXh's Blog ~]# ";
        str = user2 + "dailyquote\n" + str;
