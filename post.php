            ...
            <article class="post" itemscope itemtype="http://schema.org/BlogPosting">
                <header>
                    <h1 class="posttitle" itemprop="name headline">
                        <a href="<?php $this->options->siteUrl(); ?>"><?php $this->title() ?></a>
                        <!-- <?php if($this->user->hasLogin()): ?>
                            &nbsp;<a href="<?php $this->options->adminUrl(); ?>write-post.php?cid=<?php $this->cid(); ?>"><i class="fa fa-edit"></i></a>
                        <?php endif; ?> -->
                    </h1>
                    <div class="meta">
                        <div class="postdate">
